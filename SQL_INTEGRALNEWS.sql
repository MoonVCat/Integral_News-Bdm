...
DELIMITER $$
CREATE PROCEDURE SP_NEWS(
	vOption VARCHAR(20),
    vNEWS_ID INT,
	vSIGN VARCHAR(100),
    vTITLE VARCHAR(100),
    vDESCRIPTION VARCHAR(300),
    vTEXT_NEWS VARCHAR(300),
    vCITY VARCHAR(100),
    vSUBURB VARCHAR(100),
	...
	IF vOption = 'insertar' THEN
		INSERT INTO NEWS(`SIGN`, `TITLE`, `DESCRIPTION`, `TEXT_NEWS`, `CITY`, `SUBURB`, `COUNTRY`, `NEW_STATUS`, `DATE_OF_NEWS`, `HOUR_OF_NEWS`, `CREATION_DATE`, `CREATED_BY` ) 
		VALUES(vSIGN, vTITLE, vDESCRIPTION, vTEXT_NEWS, vCITY, vSUBURB, vCOUNTRY, vNEW_STATUS, vDATE_OF_NEWS, vHOUR_OF_NEWS, sysdate(), vCREATED_BY);
	END IF;
...
CREATE TABLE IF NOT EXISTS CATEGORIES (
    ...
    `DESCRIPTION` VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL COMMENT "",
    `COLOR`VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_spanish_ci COMMENT "",
